...
public class User extends Value {
     ...
     */
    private LinkedList<Use> operands = new LinkedList<Use>(); // All the Use edges indicating to all the value used
     ...
     * If an existed operand has already landed on that position, it will be covered.
     * @param v
     * @param pos
     */
